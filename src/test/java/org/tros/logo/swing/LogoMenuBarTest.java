...
public class LogoMenuBarTest
{
    ...
    public void testExportCanvas()
    {
        ...
        try
        {
            ...
            if (invoke != null && JFrame.class.isAssignableFrom(invoke
                .getClass()))
            {
        ...
        {
            Logger.getLogger(LogoMenuBarTest.class.getName()).log(Level.SEVERE,
                null, ex);
        }
        ...
        robot.delay(3000);
        controller.openFile(ClassLoader.getSystemClassLoader().getResource(
