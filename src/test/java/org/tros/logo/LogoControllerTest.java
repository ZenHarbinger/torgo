/*
 * Copyright 2015 Matthew Aguirre Licensed under the Apache License, Version 2.0
...
public class LogoControllerTest
{
    ...
    public void testLexicalScoping()
    {
        ...
        final java.util.prefs.Preferences prefs = java.util.prefs.Preferences
        ...
        LexicalLogoController controller = (LexicalLogoController)TorgoToolkit
            .getController("lexical-logo");
        ...
        String[] files = new String[] { "no-such-file",
            ...
            "logo/examples/antlr/fractal.txt", "logo/examples/antlr/make.txt",
            ...
            "logo/examples/antlr/repeat.txt", "logo/examples/antlr/spiral2.txt",
        ...
        for (String file : files)
        {
            ...
            try
            {
                controller.openFile(ClassLoader.getSystemClassLoader()
                    .getResource(file));
            }
            catch (Exception ex)
            {
            ...
            {
                Logger.getLogger(LogoControllerTest.class.getName()).log(
    ...
    public void testCreateConsole()
    {
        ...
        boolean checked = prefs.getBoolean("wait-for-repaint", true);
        prefs.putBoolean("wait-for-repaint", false);
        DynamicLogoController controller = (DynamicLogoController)TorgoToolkit
            .getController("dynamic-logo");
        ...
        for (String file : files)
        {
            Logger.getLogger(LogoControllerTest.class.getName()).log(Level.INFO,
                file);
            try
            {
                controller.openFile(ClassLoader.getSystemClassLoader()
