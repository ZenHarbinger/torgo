 ...
 * @author matta
 */
class LispProgram extends LispBlock {

    private static final org.tros.utils.logging.Logger LOGGER = org.tros.utils.logging.Logging.getLogFactory().getLogger(LispProgram.class);
     ...
     * @param ctx
     */
    protected LispProgram(ParserRuleContext ctx) {
        super(ctx);
    }
