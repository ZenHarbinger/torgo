...
public class lispParser extends Parser {
    ...
    public static final int RULE_program = 0, RULE_symExpr = 1, RULE_symbol = 2;
    ...
    public static class ProgramContext extends ParserRuleContext {
        ...
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof lispListener) {
                ((lispListener) listener).exitProgram(this);
            }
        }
    }
    ...
    public static class SymExprContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof lispListener) {
                ((lispListener) listener).enterSymExpr(this);
            }
        }
        ...
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof lispListener) {
                ((lispListener) listener).exitSymExpr(this);
            }
        }
    }
    ...
    public static class SymbolContext extends ParserRuleContext {
        ...
        public TerminalNode OP() {
            return getToken(lispParser.OP, 0);
        }

        public TerminalNode ID() {
            return getToken(lispParser.ID, 0);
        }

        public TerminalNode NUMBER() {
            return getToken(lispParser.NUMBER, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof lispListener) {
                ((lispListener) listener).enterSymbol(this);
            }
        }
        ...
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof lispListener) {
                ((lispListener) listener).exitSymbol(this);
            }
        }
    }
