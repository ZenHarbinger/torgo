 ...
 * @author matta
 */
class LispStatement extends LispBlock {

    private static final org.tros.utils.logging.Logger LOGGER = org.tros.utils.logging.Logging.getLogFactory().getLogger(LispStatement.class);
     ...
     * @param ctx
     */
    protected LispStatement(String command, ParserRuleContext ctx) {
        super(ctx);
        this.command = command.trim();
        super.addCommand((LispBlock) this);
    }
    ...
    public ReturnValue process(Scope scope) {
        ...
        if (null != command) {
            switch (command) {
                case "cons":
                    System.out.println("processing cons");
                    break;
                case "car":
                ...
                case "cdr":
                    ...
                    try {
                        lispParser.ListContext listCtx = (lispParser.ListContext) ctx;
                        lispParser.ListContext seq = listCtx.seq().seq().item().list();
