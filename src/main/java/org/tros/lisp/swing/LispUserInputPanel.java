...
public final class LispUserInputPanel extends JPanel implements TorgoTextConsole {
    ...
    public LispUserInputPanel(Controller controller) {
        ...
        try {
            ...
            org.tros.utils.logging.Logging.getLogFactory().getLogger(LispUserInputPanel.class).fatal(null, ex);
        }
        ...
        final java.util.prefs.Preferences prefs = java.util.prefs.Preferences.userNodeForPackage(LispUserInputPanel.class);
        int dividerLocation = prefs.getInt(LispUserInputPanel.class.getName() + "divider-location", 0);
        ...
        splitPane.addPropertyChangeListener(new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent pce) {
                prefs.putInt(LispUserInputPanel.class.getName() + "divider-location", splitPane.getDividerLocation());
            }
        });
        this.add(splitPane);
