...
public final class BasicUserInputPanel extends JPanel implements TorgoTextConsole {
    ...
    public BasicUserInputPanel(Controller controller) {
        ...
        try {
            ...
            org.tros.utils.logging.Logging.getLogFactory().getLogger(BasicUserInputPanel.class).fatal(null, ex);
        }
        ...
        final java.util.prefs.Preferences prefs = java.util.prefs.Preferences.userNodeForPackage(BasicUserInputPanel.class);
        int dividerLocation = prefs.getInt(BasicUserInputPanel.class.getName() + "divider-location", 0);
        ...
        splitPane.addPropertyChangeListener(new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent pce) {
                prefs.putInt(BasicUserInputPanel.class.getName() + "divider-location", splitPane.getDividerLocation());
            }
        });
        this.add(splitPane);
